...
exports.getItems = async (req, res) => {
    connection.query('SELECT item_id, item_name, item_image, item_price,item_category, item_discount, item_description, item_stock FROM items', function (err, result, fields) {
        if (err) {
          console.error(err);
